...
<div class="fixed-bottom">
    ...
    <input type="hidden" id="P_NOTI_URL" name="P_NOTI_URL" value="https://whole.allmyshop.co.kr/A_team/mx_rnoti.php">
    <input type="hidden" name="P_HPP_METHOD" value="2">
    <input type="hidden" id="nexturl" name="P_NEXT_URL" value="<?=$hostaddress?>/order.php?useridx=<?=$useridx?>&destinationidx=<?=$destinationidx?>&ordernum=<?=$ordernum?>&menuidx=<?=$menuidx?>&quantity=<?=$quantity?>&buy=<?=$buy?>&option_idx=<?=$option_idx?>&totalDeliveryCharge=<?=$totalDeliveryCharge?>">
