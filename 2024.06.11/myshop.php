	...
	<div class="popup-overlay" id="popup" style="display: none;">
		...
		<span class="close-btn" onclick="closePopup()">X</span>
			<?php if (!empty($adimgae)){?>
				...
				?>
				<h2>"올타고"두유제조기 구매취소처리 안내</h2>
				<p>올타고 스마트 두유 제조기 구매해주신 분들께 안내말씀 드립니다.</p>
				<p>현재 안전인증검사 결과를 대기중입니다.</p>
				<p>결과통보일자가 미정인 관계로 구매자분들의 6월11일부터</p>
				<p>일괄취소를 진행해드리고자 합니다.</P>
				<p>계좌이체 구매자분들께서는 반드시 환불계좌 등록을 해주셔야 환불처리가 가능합니다.(마이페이지 -> 무통장 환불계좌정보)</P>
				<p>카드결제 구매자분들께서는 일괄취소처리 바로 가능합니다.</P>
				<?
			}
				?>
			<div>
