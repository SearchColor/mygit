...
?>
	...
	<div class="foot_logo">
		...
		<div style='padding: 20px;'>
			...
			<div class="logo_gps">Addrees : 서울특별시 강남구 논현동 261-1 KIDC</div>
		</div>
	</div>
	...
	<div class="footer">
		...
		<div class="footer_info">
			<div class="footer_lt"><strong><span style="font-size: 12px;">대표번호 : 02-6326-9192</span></strong><br>
				...
				<span style="font-size: 12px;">사업자소재지 : 서울특별시 성동구 아차산로 107,4층 402호 제트 128 </span><br>
				<span style="font-size: 12px;">소재지 : 서울특별시 강남구 논현동 261-1 KIDC</span><br>
...
function closeset(){
	...
	if (dontShowAgain) {
    setCookie("announcement2", "false", 1);
	closePopup();
    }
}
function checkPopupVisibility() {
    var announcement = getCookie("announcement2");
